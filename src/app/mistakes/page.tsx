...
import { BookOpen, Filter, Search, ChevronRight } from 'lucide-react'
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-gradient-to-r from-purple-500 to-blue-500 px-5 pt-12 pb-6 text-white">
        ...
        <p className="text-purple-100 text-sm">
          共 {totalCount} 道 · 已掌握 {masteredCount} 道
        </p>
      ...
      <div className="px-5 py-4 pb-24">
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-slate-500 font-medium">没有找到匹配的错题</p>
            {mistakes.length === 0 && (
              <Link href="/upload">
                <button className="btn-primary mt-4">📷 上传第一道错题</button>
              </Link>
            )}
          </div>
        ) : (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      ...
                      <span className="text-xs text-slate-400">{mistake.knowledgePoint}</span>
                    </div>
                  ...
                  <div className="flex flex-col gap-2 flex-shrink-0">
                    {mistake.status !== 'MASTERED' && (
                      <Link href={`/practice?mistakeId=${mistake.id}`}>
                        <button className="flex items-center gap-1 bg-blue-500 text-white px-3 py-1.5 rounded-xl text-sm font-medium active:scale-95 transition-all">
